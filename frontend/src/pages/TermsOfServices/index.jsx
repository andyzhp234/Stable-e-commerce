  ...
  return (
    <div className="legal">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <a
              href="https://www.stable-store.com/"
      ...
      <p>
        ...
        JWT-token is a digitally signed JSON object that contains information
        about the user's identity and is used to authenticate the user when they
        log in to our website. The JWT-token is stored in the local storage of
        the user's browser, which allows us to keep the user logged in even
        after they close their browser or leave our website. We take all
        necessary precautions to keep the user data safe and secure, including
        the JWT-token stored in the local storage. Please note that while we
        take all necessary precautions to keep user data safe and secure, there
        is always a risk of unauthorized access or data breaches, and we cannot
        guarantee complete security. As a user, it is your responsibility to
        keep your account and user data safe. We recommend that you do not share
        your device with others, use a secure browser, and do not share your
        account information with others. By using our website, you agree to the
        use of JWT-token for authentication and the storage of the token in the
        local storage of your browser. If you have any questions or concerns
        about the use of the JWT-token or local storage, please contact us.
      </p>
      <p>
        Accounts created on our website are subject to periodic deletion. While
        we make every effort to delete accounts in a timely manner, the exact
        timing of these deletions may vary and is not guaranteed. By creating an
        account on our website, you acknowledge and agree that your account may
        be deleted at any time without prior notice. We take the privacy of our
        users seriously and do not share this information with third parties,
        except as required by law. We'll never sell your personal information to
        third parties, and we won't use your name and email in marketing
      ...
      <p>
        ...
        applicable law, we will not be liable for any direct, indirect,
        ...
        intangible losses, arising out of or related to your use of our
        services. you further acknowledge and agree that we will not be
        responsible for any data breaches, hacking, viruses, or other
        unauthorized access to your personal information, and that you use our
      ...
      <p>
        Please be aware that uploading any inappropriate content, including but
        not limited to offensive language, explicit material, copyrighted
        material that you do not have permission to use, or any other materials
        that are harmful, threatening, abusive, or harassing in nature, is
        strictly prohibited and may result in permanent deletion of your
        account. This also includes the use of the Services for spamming,
        advertising, or other unauthorized commercial purposes. We reserve the
        right to take any necessary action to enforce these policies, including
